...
public class BookItem extends Book{
    ...
    BookItem(String ISBN, String title, String publisher, String author, String publicationDate, int Copies, double price, Date issueDate, Date dueDate, String description) {
        super(ISBN, title, publisher, author, publicationDate, description);
        this.price = price;
        this.Copies = Copies;
        this.status = BookStatus.AVAILABLE;
        this.borrowDate = issueDate;
